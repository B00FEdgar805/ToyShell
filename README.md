...
This was a project for Operating Systems class that used Libstephen SHell as the base code with other feature having to be added. The program has basic UNIX commands as well as error handling. Thr program is on a single C file. It compiles and runs with no dependecies. It was made in Xcode but will run in a terminal just fine. 
